...
var TimesheetComponent = /** @class */ (function () {
    ...
    TimesheetComponent.prototype.getResources = function () {
        var _this = this;
        this.timesheetService.getResources().subscribe(function (resources) { return _this.resources = resources; }, function (error) { return console.log(error); });
    };
    TimesheetComponent.prototype.getTasks = function () {
        var _this = this;
        this.tasksService.getTasks().subscribe(function (tasks) { return _this.tasksData = tasks; }, function (error) { return console.log(error); });
    };
...
module.exports = __webpack_require__(/*! D:\Integrated angular spring boot timesheet project\Employee-Timesheet-System\static-resources\src\main.ts */"./src/main.ts");
